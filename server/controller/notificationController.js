import { Notification } from "../models/notification.js" // Assuming Notification model exists
...
export const createNotification = async (
  ...
  try {
    ...
    if (io) {
      io.to(userId.toString()).emit("notification", newNotification) // Ensure userId is a string for the room name
