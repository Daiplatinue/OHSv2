    ...
    <>
      ...
      >
        ...
        <section
          ...
          className="relative min-h-screen bg-fixed bg-cover bg-center bg-no-repeat overflow-hidden"
        >
          <img
          ...
          <div
            className={`absolute top-100 left-4 text-[10px] font-mono text-yellow-500 opacity-60 md:text-xs transition-all duration-1000 delay-300 ${heroAnimationComplete ? "opacity-60 translate-x-0" : "opacity-0 -translate-x-10"}`}
          >
            14°35'46.0"N
          </div>
          <div
            className={`absolute top-100 right-4 text-[10px] font-mono text-yellow-500 opacity-60 md:text-xs transition-all duration-1000 delay-300 ${heroAnimationComplete ? "opacity-60 translate-x-0" : "opacity-0 translate-x-10"}`}
          >
            121°01'15.0"E
          </div>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 md:px-12">
            <div
              className={`max-w-7xl mx-auto text-center transition-all duration-1000 ease-out ${heroAnimationComplete ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
            >
              <h1 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl leading-none text-gray-300">
                <div
                  className={`transition-transform duration-1000 delay-100 ${heroAnimationComplete ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
                >
                ...
                <div
                  className={`transition-transform duration-1000 delay-500 ${heroAnimationComplete ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
                >
                  <span className="block text-gray-300 font-medium">IN CEBU CITY</span>
                </div>
              </h1>

              <div
                className={`mt-12 transition-all duration-1000 delay-700 ${heroAnimationComplete ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
              >
                <button
          ...
          <div
            className={`absolute bottom-8 left-0 right-0 hidden md:block transition-all duration-1000 delay-800 ${heroAnimationComplete ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
          ...
          <div
            className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 md:hidden transition-all duration-1000 delay-900 ${heroAnimationComplete ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <button onClick={scrollToServices} className="flex flex-col items-center animate-bounce">
