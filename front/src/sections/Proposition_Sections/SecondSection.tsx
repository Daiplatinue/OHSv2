...
function SecondSection({
  ...
  return (
    <section
      ...
      className="relative min-h-screen bg-white text-gray-600 py-8 px-4 sm:py-16 sm:px-8 md:px-16 lg:px-20"
    >
                ...
                <div className="w-full md:w-[25rem]">
                  ...
                  <p className="text-[13px] tracking-[0.02em] leading-[1.6] uppercase mt-4 sm:mt-6">
                    ...
                    <span
                      className="cursor-pointer hover:text-sky-600 transition-colors duration-300 text-sky-500"
                      {...(isMobile
                        ? { onClick: () => handleMobileClick("JV ALMENDRAS AS DOCUMENTOR") }
                        : {
                            onMouseEnter: () => handleTeamMemberHover("JV ALMENDRAS AS DOCUMENTOR"),
                            onMouseLeave: handleTeamMemberLeave,
                          })}
                    >
