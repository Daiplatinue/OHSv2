...
import { benefits } from "../propositionData" // Assuming this file exists and is accessible
      ...
      <div key={index} className="w-screen h-full relative flex items-center justify-center p-4 md:p-8 bg-white">
        ...
        <div className="relative w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white">
          <div className="lg:col-span-7 order-2 lg:order-1">
            <div
              className="aspect-[4/3] rounded-xl sm:rounded-3xl bg-cover bg-center mt-8 sm:mt-10"
              style={{ backgroundImage: `url(${benefit.image})` }}
            >
              <div className="w-full h-full rounded-xl sm:rounded-3xl bg-black/40 flex items-end p-4 sm:p-8">
                <div className="text-white">
                  <p className="text-xs sm:text-sm uppercase tracking-widest opacity-80 mb-1 sm:mb-2">
                    Featured Solution
                  </p>
                  <h3 className="text-lg sm:text-xl md:text-2xl text-gray-200 font-light">{benefit.subtitle}</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative order-1 lg:order-2 flex justify-center">
              <div
                className="aspect-square w-full max-w-sm sm:max-w-md rounded-xl sm:rounded-2xl bg-cover bg-center shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-500"
                style={{ backgroundImage: `url(${benefit.image})` }}
              >
                <div className="w-full h-full rounded-xl sm:rounded-2xl bg-gradient-to-t from-black/30 to-transparent"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
          ...
          <div className="relative p-4 sm:p-8 flex items-center justify-center order-1 lg:order-2">
            <div
              ...
              style={{ backgroundImage: `url(${benefit.image})` }}
            >
              <div className="w-full h-full rounded-xl sm:rounded-2xl bg-gradient-to-br from-transparent to-black/20"></div>
            </div>
          </div>
        </div>
      </div>,
        ...
        <div className="relative w-full max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 relative order-1 lg:order-2 flex justify-center">
              <div
                className="aspect-[3/2] w-full max-w-md sm:max-w-lg lg:max-w-none rounded-xl sm:rounded-3xl bg-cover bg-center shadow-2xl transform -rotate-2"
                style={{ backgroundImage: `url(${benefit.image})` }}
              >
