    ...
    <section className="relative min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 py-24 overflow-hidden tracking-tight">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center p-6 sm:p-8 bg-white rounded-2xl border border-gray-100">
            <div className="text-2xl sm:text-3xl font-medium text-sky-500 mb-2 sm:mb-3">99.9%</div>
            <div className="text-sm text-gray-600 font-medium">Uptime</div>
            <div className="text-xs text-gray-400 mt-1">System Reliability</div>
          </div>
          <div className="text-center p-6 sm:p-8 bg-white rounded-2xl border border-gray-100">
            <div className="text-2xl sm:text-3xl font-medium text-sky-500 mb-2 sm:mb-3">&lt;50ms</div>
          ...
          <div className="text-center p-6 sm:p-8 bg-white rounded-2xl border border-gray-100">
            <div className="text-2xl sm:text-3xl font-medium text-sky-500 mb-2 sm:mb-3">256-bit</div>
          ...
          <div className="text-center p-6 sm:p-8 bg-white rounded-2xl border border-gray-100">
            <div className="text-2xl sm:text-3xl font-medium text-sky-500 mb-2 sm:mb-3">24/7</div>
