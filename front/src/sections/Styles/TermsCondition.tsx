...
const termsContent = [
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">1. Introduction and Acceptance of Terms</h3>
    ...
    <img src="https://cdn.pixabay.com/photo/2022/04/11/18/03/food-delivery-service-7126334_1280.jpg" alt="Legal document illustration" class="w-full h-auto rounded-lg my-6" />
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">2. User Accounts and Registration</h3>
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">3. Privacy Policy Overview</h3>
    ...
    <img src="https://cdn.pixabay.com/photo/2023/10/21/13/58/ai-generated-8331478_1280.jpg" alt="Privacy shield illustration" class="w-full h-auto rounded-lg my-6" />
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">4. Acceptable Use and Conduct</h3>
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">5. Intellectual Property Rights</h3>
    ...
    <img src="https://cdn.pixabay.com/photo/2024/04/26/17/22/supermarket-8722293_960_720.jpg" alt="Intellectual property illustration" class="w-full h-auto rounded-lg my-6" />
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">6. Disclaimers and Limitation of Liability</h3>
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">7. Termination</h3>
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">8. Governing Law and Dispute Resolution</h3>
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">9. Changes to Terms and Platform</h3>
    ...
    <img src="https://cdn.pixabay.com/photo/2023/12/19/22/46/business-8458541_1280.jpg" alt="Update illustration" class="w-full h-auto rounded-lg my-6" />
  ...
  `,
  `
    <h3 class="text-xl font-medium mb-4 text-sky-500">10. Miscellaneous Provisions and Contact Information</h3>
...
function TermsCondition({ onClose }: TermsConditionProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 font-['SF_Pro_Display',-apple-system,BlinkMacSystemFont,sans-serif]">
      ...
      >
        ...
        <h2 className="text-2xl font-medium text-center mb-6 text-sky-500">Terms and Services & Privacy Policy</h2>
