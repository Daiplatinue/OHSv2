...
interface Account {
  ...
  // New fields for document previews (both Service Provider and Customer)
  ...
  frontIdPreview?: string | null // Customer specific
  backIdPreview?: string | null // Customer specific
  profilePicturePreview?: string | null // Customer specific
  coverPhoto?: string | null
  // Anomaly status fields (both Service Provider and Customer)
  ...
  frontIdAnomaly?: boolean // Customer specific
  backIdAnomaly?: boolean // Customer specific
}
...
const documentPreviewMap: { [key: string]: keyof Account } = {
  ...
  bondingInsuranceAnomaly: "bondingInsuranceAnomaly",
